		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					...
					<h2><span class="title">${reservationInfo.getProduct().getDescription()}</span></h2>
				</div>
				<!-- 리뷰 별점 -->
				<div class="write_act">
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="hidden" class="hidden_input" id="productId" value="${reservationInfo.getProduct().getId()}">
						<input type="hidden" class="hidden_input" id="reservationInfoId" value="${reservationInfo.getId()}">
...
<li class="item" style="display: inlineblock;">
	<a class="anchor">
...
<script src="./js/reviewWritePage.js"></script>
<script>
	document.addEventListener("DOMContentLoaded", ReviewWritePage.initialize());
</script>
