let detail = {
    imageArea: {
        ...
        loadImage: function() {
            ...
            requestAjax({
                url: "./api/productImages?type=et&id=" + productId,
                method: "GET",
                ...
                success: function(response) {
                    ...
                    if (resultJson.body.size === 0) {
                        this.prevButton.style.display = "none";
                        this.nextButton.style.display = "none";
                        return;
                    }

                    this.maxCount.innerText = resultJson.body.size + 1;

                    let bindTemplate = Handlebars.compile(this.itemTemplate.innerText);
                    this.slider.parentUl.innerHTML += bindTemplate(resultJson.body.items);
                }.bind(this)
            });
        },
