...
<html lang="ko">
    ...
    <head>
        ...
        <script src="./js/common/ajax-request.js"></script>
        <script src="./js/common/formatter.js"></script>
        <script src="./js/common/ticket-element.js"></script>
        <script src="./js/common/validation-checker.js"></script>
    </head>
    ...
    <body>
        <div id="container">
            ...
            <div class="ct">
                <div class="ct_wrap">
                    <div class="top_title">
                        <a href="./detail?id=${product.getId()}" class="btn_back" title="이전 화면으로 이동">
                        ...
                        <div class="container_visual" style="width: 414px;">
                            <ul class="visual_img">
                                <li class="item" style="width: 414px;">
                                    <img alt="" class="img_thumb" src="./${product.getSaveFileName()}">
                                    <span class="img_bg"></span>
                                    <!-- div class="preview_txt"> <h2 class="preview_txt_tit"></h2> <em class="preview_txt_dsc">₩12,000 ~ </em><em class="preview_txt_dsc">2017.2.17.(금)~2017.4.18.(화), 잔여티켓 2769매</em> </div-->
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="section_store_details">
                        <div class="store_details">
                            ...
                            <p class="dsc">
                                장소 :
                                <br>
                                ${product.getPlaceName()}
                            </p>
                            <h3 class="in_tit">관람시간</h3>
                            <p class="dsc">
                                ${product.getOpeningHours()}
                            </p>
                        </div>
                    </div>
                    <div class="section_booking_ticket">
                        <div class="ticket_body">
                            <c:forEach var="item" items="${product.getProductPriceList()}">
                                <div class="qty">
                                    <div class="priceId" style="display:none">${item.getId()}</div>
                                    <fmt:formatNumber value="${item.getPrice()}" var="formattedPrice" pattern="#,###"/>
                                    <div class="count_control">
                                        <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
                                        <div class="clearfix" data-index="${status.index}">
                                            <a class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"></a>
                                            <input type="tel" class="count_control_input disabled" value="0" readonly="readonly" title="수량">
                                    ...
                                    <div class="qty_info_icon">
                                        <strong class="product_amount">
                                            <span>${item.getPriceTypeName()}</span>
                                        </strong>
                                        <strong class="product_price">
                                            <span class="price">${formattedPrice}</span>
                                            <span class="price_type">원</span>
                                        </strong>
                                        <em class="product_dsc">${formattedPrice}원 (${item.getDiscountRate()}% 할인가)</em>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
                        ...
                        <div class="booking_form_wrap">
                            <div class="form_wrap">
                                ...
                                <form class="form_horizontal" action="../reserve" method="post">
                                    <input type="hidden" id="productId" value="${product.getId()}"></input>
                                    ...
                                    <div class="inline_form last">
                                        ...
                                        <div class="inline_control">
                                            <p class="inline_txt selected">
                                                <span id="reservateDate">${reservationDate}</span>, 총
                        ...
                        <div class="section_booking_agreement">
                            ...
                            <div class="agreement">
                                ...
                                <div class="useragreement_details">&lt;개인정보 수집 및 이용 동의&gt;<br><br>
                                    ...
                                    4. 동의 거부권 등에 대한 고지: 정보주체는 개인정보의 수집 및 이용 동의를 거부할 권리가 있으나, 이 경우 상품 및 서비스 예약이 제한될 수 있습니다.<br></div>
                            </div>
                            <!-- [D] 약관 보기 클릭 시 agreement에 open 클래스 추가 -->
                            <div class="agreement">
                                <span class="chk_txt_span">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", reservePage.initialize());
        </script>
    </body>
