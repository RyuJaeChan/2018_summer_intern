...
<html lang="ko">
    ...
    <body>
            ...
            <div class="ct main">
                <div>
                        ...
                        <div class="group_visual">
                            <div>
                                <div class="container_visual" style="width: 414px;">
                                    <ul style="height: 100%;" class="visual_img detail_swipe">
                                        <li class="item" style="height: 100%; width: 414px;">
                                            <img alt="" class="img_thumb" style="height: 100%;" src="./${product.saveFileName}">
                    ...
                    <div class="section_btn">
                        <a href="./reserve?id=${product.getId()}">
                    ...
                    <div class="section_review_list">
                        <div class="review_box">
                            ...
                            <div class="short_review_area">
                                ...
                                <c:if test="${product.getUserCommentList().size() eq 0}">
                                    <h3 style="height: 70px; line-height:70px;">등록된 리뷰가 없습니다.</h3>
                                </c:if>
                                <ul class="list_short_review">
                                    <c:forEach var="item" items="${product.getUserCommentList()}">
                                        <li class="list_item">
                                            <div>
                        ...
                        <a class="btn_review_more" href="./review?id=${product.getId()}">
                            ...
                            <div class="detail_area">
                                <div class="detail_info">
                                    ...
                                    <ul class="detail_info_group">
                                        ...
                                        <!-- <li class="detail_info_lst"> <strong class="in_tit">[공연정보]</strong> <ul class="in_img_group"> <li class="in_img_lst"> <img alt="" class="img_thumb"
                                        src="https://ssl.phinf.net/naverbooking/20170131_255/1485825099482NmYMe_JPEG/%B0%F8%BF%AC%C1%A4%BA%B8.jpg?type=a1000"> </li> </ul> </li> -->
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="lst_store_info_wrap">
                                        <ul class="lst_store_info">
                                            <li class="item">
                                                ...
                                                <span class="item_rt">
                                                    <a href="tel:${product.tel}" class="store_tel">${product.tel}</a>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
        ...
        {{#each items}}
		<li class="item" style="height: 100%; width: 414px;">
			<img alt="" style="height: 100%;" class="img_thumb" src="{{this.saveFileName}}">
            <span class="img_bg"></span>
            <div class="visual_txt">
                <div class="visual_txt_inn">
                    <h2 class="visual_txt_tit">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", detail.initialize());
        </script>
    </body>
