...
<html lang="ko">
    ...
    <body>
                        ...
                        <ul class="summary_board">
                            <li class="item">
                                ...
                                <a href="#" class="link_summary_board on">
                                    ...
                                    <em class="tit">전체</em>
                                    <span class="figure">${confirmedList.size()+usedList.size()+canceledList.size()}</span>
                                </a>
                            </li>
                            <li class="item">
                            ...
                            <li class="item">
                                <a href="#" class="link_summary_board">
                                    ...
                                    <span class="figure">${usedList.size()}</span>
                                </a>
                            </li>
                            <li class="item">
                                <a href="#" class="link_summary_board">
                                    ...
                                    <span class="figure">${canceledList.size()}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="wrap_mylist">
                            <ul class="list_cards" ng-if="bookedLists.length > 0">
                                ...
                                <li class="card confirmed">
                                    <c:if test="${confirmedList.size() ne 0}">
                                    ...
                                    <c:forEach items="${confirmedList}" var="item">
                                                ...
                                                <div class="card_body">
                                                    ...
                                                    <div class="middle">
                                                        <div class="card_detail">
                                                            <em class="booking_number">No.${item.getId()}</em>
                                                            <h4 class="tit">${item.getProduct().getDescription()}</h4>
                                                            <ul class="detail">
																<li class="item">
                                                            ...
                                                            <div class="price_summary">
                                                                ...
                                                                <em class="price_amount">
                                                                    <span><fmt:formatNumber value="${item.getTotalPrice()}" pattern="###,###,###"/></span>
                                ...
                                <li class="card used cancel">
                                    <c:if test="${canceledList.size() ne 0}">
                                        <div class="link_booking_details">
                                            <div class="card_header">
                                                <div class="left"></div>
                                                <div class="middle">
                                    ...
                                    <c:forEach items="${canceledList}" var="item">
                                        <article class="card_item">
                                            <a href="#" class="link_booking_details">
                                                <div class="card_body">
                                                    <div class="left"></div>
		...
		<script>
			document.querySelector("DOMContentLoaded", myreservationPage.initialize());
		</script>
    </body>
