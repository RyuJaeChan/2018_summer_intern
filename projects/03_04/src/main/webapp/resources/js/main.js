...
function loadPromotions() {
  requestAjax(formatUrl(GET_PROMOTIONS, 0, 0), function() {
    ...
    addPromotionsList(resultJson.items, resultJson.size);
...
function loadProducts() {
  ...
  requestAjax(formatUrl(GET_PRODUCTS, 0, categoryId), function() {
    ...
    setCategoryCount(resultJson.size);

    addProductsList(resultJson.items, resultJson.size);
