...
<body>
        ...
        <div class="event">
            ...
            <div class="section_event_tab">
                <ul class="event_tab_lst tab_lst_min">
                    <li class="item">
                        <a class="anchor active" data-category="0"> <span>전체리스트</span> </a>
                    </li>
                </ul>
            </div>
    ...
    <li class="item">
        <a class="anchor" data-category="{id}"> <span>{name}</span> </a>
    </li>
    </script>

    <script type="rv-template" id="promotionItem">
    <li class="item" style="background-image: url(./{saveFileName}); width:414px;">
    ...
    <script type="rv-template" id="itemList">
        <li class="item">
            <a class="item_book" href="./detail?id={displayInfoId}">
