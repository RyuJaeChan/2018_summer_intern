...
<body>
        ...
        <div class="ct main">
            <div>
                        ...
                        <div>
                            <div class="container_visual" style="width: 414px;">
                                <ul style="height: 100%;" class="visual_img detail_swipe">
                                    <li class="item" style="height: 100%; width: 414px;"> <img alt="" class="img_thumb" style="height: 100%;" src="./${product.saveFileName}"> <span class="img_bg"></span>
                ...
                <div class="section_review_list">
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="graph_mask"> <em class="graph_value" style="width: <fmt:formatNumber value="${score*10}" />%;"></em> </span>
                                <strong class="text_value"> <span><fmt:formatNumber value="${score}" pattern="0.0"/></span> <em class="total">5.0</em> </strong>
                    ...
                    <a class="btn_review_more" href="./review?id=${product.getId()}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
    ...
    <div id="photoviwer"></div>
		...
		{{#each items}}
		<li class="item" style="height: 100%; width: 414px;"> <img alt="" style="height: 100%;" class="img_thumb" src="{{this.saveFileName}}">
			<span class="img_bg"></span>
			<div class="visual_txt">
				<div class="visual_txt_inn">
					<h2 class="visual_txt_tit"> <span>{{this.description}}</span> </h2>
				</div>
			</div>
		</li>
		{{/each}}
